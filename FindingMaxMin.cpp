...
int main() {
    ...
    char path[] = "Data.csv";   // Инициализация переменной, которая хранит название файлов с исходным массивом 
    char path2[] = "results.txt";   // Инициализация переменной, которая хранит название файлов с выходными данными
